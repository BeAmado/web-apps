      ...
      <div className="right-floating">
        <ul className="inline-list">
          ...
          <li id="fiscal-year" className="upper-label">
            <label className="upper-label" for="year-select">Ano de exerc&iacute;cio</label>
          ...
          <li id="organization" className="upper-label">
            <label className="upper-label" for="organization-select">Organiza&ccedil;&atilde;o</label>
